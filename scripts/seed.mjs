...
const PROJECT_ID = 'uii0qugi'
const DATASET = 'production'
const API_VERSION = '2024-01-01'
const TOKEN = 'skRIhey92sMCEfRFDuAu564oT6Dv7Fh2vZXnjSc6cS5bbSaEgttkCEF9Pp1gsDJuR3CqUMbh2Oszn8spA'

const BASE_URL = `https://${PROJECT_ID}.api.sanity.io/v${API_VERSION}/data/mutate/${DATASET}`
...
async function mutate(mutations) {
  ...
  if (!res.ok) {
    throw new Error(`Sanity error: ${JSON.stringify(data)}`)
  }
  return data
}

function createOrReplace(doc) {
...
const blogPosts = [
  {
    ...
    slug: { _type: 'slug', current: 'hidden-restaurants-dar-es-salaam' },
  ...
  },
  {
    ...
    slug: { _type: 'slug', current: 'budget-serengeti-safari-guide' },
  ...
  },
  {
    ...
    slug: { _type: 'slug', current: 'solo-female-travel-tanzania' },
  ...
  },
  {
    _id: 'blogpost-005',
    _type: 'blogPost',
    title: 'Best Boutique Hotels in Zanzibar Under $150 Per Night',
    slug: { _type: 'slug', current: 'best-boutique-hotels-zanzibar' },
    category: 'hotels-restaurants',
...
const packages = [
  {
    ...
    slug: { _type: 'slug', current: 'serengeti-wildlife-safari' },
    ...
    pricingTiers: [
      { _key: 'tier1', minPeople: 1, maxPeople: 2, totalPrice: 1200 },
      { _key: 'tier2', minPeople: 3, maxPeople: 4, totalPrice: 1600 },
      { _key: 'tier3', minPeople: 5, maxPeople: 8, totalPrice: 2200 },
    ],
  ...
  },
  {
    ...
    slug: { _type: 'slug', current: 'zanzibar-island-escape' },
    ...
    pricingTiers: [
      { _key: 'tier1', minPeople: 1, maxPeople: 2, totalPrice: 900 },
      { _key: 'tier2', minPeople: 3, maxPeople: 4, totalPrice: 1400 },
      { _key: 'tier3', minPeople: 5, maxPeople: 8, totalPrice: 1900 },
      { _key: 'tier4', minPeople: 9, maxPeople: 12, totalPrice: 2600 },
    ],
    included: ['Boutique accommodation', 'Breakfast daily', 'All tours listed', 'Airport transfers'],
    excluded: ['Flights to Zanzibar', 'Lunch and dinner', 'Travel insurance'],
    featured: true,
    category: 'beach',
  },
  {
    ...
    pricingTiers: [
      { _key: 'tier1', minPeople: 1, maxPeople: 2, totalPrice: 350 },
      { _key: 'tier2', minPeople: 3, maxPeople: 4, totalPrice: 550 },
      { _key: 'tier3', minPeople: 5, maxPeople: 8, totalPrice: 750 },
    ],
    included: ['Boutique hotel 1 night', 'Breakfast', 'All guided tours', 'Local transport'],
    excluded: ['Flights', 'Lunch and dinner', 'Personal shopping'],
    featured: true,
    category: 'city',
  },
  {
    _id: 'package-004',
    _type: 'travelPackage',
    title: 'Kilimanjaro Foothills and Waterfalls',
    slug: { _type: 'slug', current: 'kilimanjaro-foothills-waterfalls' },
    ...
    highlights: ['Materuni waterfalls hike', 'Coffee farm tour and tasting', 'Chagga village walk', 'Kilimanjaro views', 'Moshi town exploration', 'Local homestay option'],
    location: 'Moshi and Kilimanjaro Region, Tanzania',
    duration: '2 Days / 1 Night',
    availabilityMonths: ['January', 'February', 'June', 'July', 'August', 'September', 'October', 'November', 'December'],
    pricingTiers: [
      { _key: 'tier1', minPeople: 1, maxPeople: 2, totalPrice: 280 },
      { _key: 'tier2', minPeople: 3, maxPeople: 4, totalPrice: 440 },
      { _key: 'tier3', minPeople: 5, maxPeople: 8, totalPrice: 680 },
    ],
    included: ['Accommodation', 'All meals', 'Guided hikes', 'Coffee tasting', 'Village entry fees'],
    excluded: ['Flights or bus to Moshi', 'Travel insurance', 'Personal gear'],
    featured: false,
    category: 'adventure',
  },
  {
    ...
    availabilityMonths: ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'],
    pricingTiers: [
      { _key: 'tier1', minPeople: 1, maxPeople: 2, totalPrice: 180 },
      { _key: 'tier2', minPeople: 3, maxPeople: 4, totalPrice: 280 },
      { _key: 'tier3', minPeople: 5, maxPeople: 8, totalPrice: 400 },
      { _key: 'tier4', minPeople: 9, maxPeople: 15, totalPrice: 600 },
    ],
...
const portfolio = [
  {
    ...
    results: [
      { _key: 'r1', label: 'Photos Delivered', value: '45+' },
      { _key: 'r2', label: 'Reels Created', value: '12' },
      { _key: 'r3', label: 'Engagement Increase', value: '340%' },
    ],
    featured: true,
    order: 1,
  },
  {
    ...
    results: [
      { _key: 'r1', label: 'Reach', value: '2.1M+' },
      { _key: 'r2', label: 'Countries Reached', value: '18' },
      { _key: 'r3', label: 'Content Pieces', value: '30' },
    ],
    featured: true,
    order: 2,
  },
  {
    ...
    results: [
      { _key: 'r1', label: 'Follower Growth', value: '18K' },
      { _key: 'r2', label: 'Growth Period', value: '90 days' },
      { _key: 'r3', label: 'Posts Created', value: '87' },
    ],
    featured: true,
    order: 3,
  },
  {
    ...
    results: [
      { _key: 'r1', label: 'Stories Published', value: '8' },
      { _key: 'r2', label: 'Digital Readers', value: '500K+' },
    ],
    featured: false,
    order: 4,
  },
  {
    ...
    results: [
      { _key: 'r1', label: 'Participants', value: '12' },
      { _key: 'r2', label: 'Days', value: '7' },
      { _key: 'r3', label: 'Content Generated', value: '200+' },
    ],
    featured: false,
    order: 5,
  },
...
const singletons = [
  {
    ...
    stats: [
      ...
      { _key: 's2', value: '120+', label: 'Destinations Covered' },
      { _key: 's3', value: '30+', label: 'Brand Partnerships' },
      { _key: 's4', value: '4+', label: 'Years Creating' },
    ],
  },
  {
    _id: 'siteSettings',
...
// ============================================================
async function seed() {
  const allDocs = [...blogPosts, ...packages, ...portfolio, ...singletons]

  console.log(`\n🌍 Seeding ${allDocs.length} documents to Sanity (project: ${PROJECT_ID})\n`)

  // Batch into groups of 10 to avoid hitting API limits
  const batchSize = 10
  for (let i = 0; i < allDocs.length; i += batchSize) {
    ...
    try {
      ...
      console.log(`  ✓ Batch ${Math.floor(i / batchSize) + 1}: ${ids.join(', ')}`)
    } catch (err) {
